  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="flex-1 pt-28 pb-12">
        <div className="max-w-6xl mx-auto bg-black/60 rounded-xl shadow-lg border border-white/10 p-8 lg:p-12 animate-fade-in">
          {/* Header */}
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12 gap-6 animate-slide-down">
            <div>
              <h1 className="text-5xl lg:text-6xl font-bold mb-3 hover:text-gray-300 transition-colors duration-300">Shubham Jakhete</h1>
              <h2 className="text-2xl text-gray-400 font-medium hover:text-gray-300 transition-colors duration-300">Full Stack Developer</h2>
            </div>
          </div>
          ...
          {/* Experience */}
          <section className="mb-12 animate-slide-up opacity-0" style={{ animationDelay: '400ms' }}>
            <h3 className="text-2xl font-semibold text-white mb-6 tracking-wide hover:text-gray-300 transition-colors duration-300">Experience</h3>
            <div className="space-y-6">
              <div className="transform hover:scale-105 transition-transform duration-300 hover:bg-white/5 p-6 rounded-lg">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  <span className="text-xl font-bold">Full Stack Web Developer</span>
                  <span className="text-gray-400 text-base mt-1 md:mt-0">2023 - 2024</span>
                </div>
                <div className="text-gray-400 text-lg mb-4">Beaver Ecoworks, Remote</div>
                <ul className="list-disc list-inside text-gray-300 text-base space-y-3">
              ...
              <div className="transform hover:scale-105 transition-transform duration-300 hover:bg-white/5 p-6 rounded-lg">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  ...
                  <span className="text-gray-400 text-base mt-1 md:mt-0">2021 - 2021</span>
                </div>
                <div className="text-gray-400 text-lg mb-4">Stdygrp Tech, Pune</div>
                <ul className="list-disc list-inside text-gray-300 text-base space-y-3">
          ...
          {/* Education */}
          <section className="mb-12 animate-slide-up opacity-0" style={{ animationDelay: '600ms' }}>
            <h3 className="text-2xl font-semibold text-white mb-6 tracking-wide hover:text-gray-300 transition-colors duration-300">Education</h3>
            <div className="space-y-4">
              <div className="transform hover:scale-105 transition-transform duration-300 hover:bg-white/5 p-6 rounded-lg">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                  <span className="text-xl font-bold">MS Computer Science</span>
                  <span className="text-gray-400 text-base mt-1 md:mt-0">2024 - 2026</span>
                </div>
                <div className="text-gray-400 text-lg">California State University, Fullerton</div>
              </div>
              <div className="transform hover:scale-105 transition-transform duration-300 hover:bg-white/5 p-6 rounded-lg">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                  <span className="text-xl font-bold">BSc-MSc Computer Science</span>
                  <span className="text-gray-400 text-base mt-1 md:mt-0">2015 - 2021</span>
                </div>
                <div className="text-gray-400 text-lg">Savitribai Phule Pune University, Pune</div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12 animate-slide-up opacity-0" style={{ animationDelay: '800ms' }}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Relevant Courses */}
              <div className="transform hover:scale-105 transition-transform duration-300 hover:bg-white/5 p-6 rounded-lg">
                <h3 className="text-2xl font-semibold text-white mb-6 tracking-wide hover:text-gray-300 transition-colors duration-300">Relevant Courses</h3>
                <ul className="list-disc list-inside text-gray-300 text-base space-y-3">
              ...
              {/* Skills */}
              <div className="transform hover:scale-105 transition-transform duration-300 hover:bg-white/5 p-6 rounded-lg">
                <h3 className="text-2xl font-semibold text-white mb-6 tracking-wide hover:text-gray-300 transition-colors duration-300">Skills</h3>
